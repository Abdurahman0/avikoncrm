...
const ORDER_STATUS_KEYS: Record<string, string> = {
  ...
  packing: 'labels.orderStatus.packing',
  shipped: 'labels.orderStatus.shipped',
  delivered: 'labels.orderStatus.delivered',
  closed: 'labels.orderStatus.closed',
  audit_pending: 'labels.orderStatus.audit_pending',
  audit_paid: 'labels.orderStatus.audit_paid',
  moderation: 'labels.orderStatus.moderation',
  contract_ready: 'labels.orderStatus.contract_ready',
  payment_pending: 'labels.orderStatus.payment_pending',
  paid: 'labels.orderStatus.paid',
  sent: 'labels.orderStatus.sent',
  signed: 'labels.orderStatus.signed',
  canceled: 'labels.orderStatus.canceled',
...
const USER_PERMISSION_LABEL_KEYS: Record<string, string> = {
  ...
  can_view_integrations: 'labels.permissions.can_view_integrations',
  can_manage_ai_settings: 'labels.permissions.can_manage_ai_settings',
  can_view_ai_settings: 'labels.permissions.can_view_ai_settings',
  can_view_logs: 'labels.permissions.can_view_logs',
  'dashboard.view': 'labels.permissions.dashboard.view',
  'audit_logs.view': 'labels.permissions.audit_logs.view',
  ...
  'clients.verify': 'labels.permissions.clients.verify',
  ...
  'company.view': 'labels.permissions.company.view',
  'company.manage': 'labels.permissions.company.manage',
  'members.view': 'labels.permissions.members.view',
  'members.manage': 'labels.permissions.members.manage',
  'orders.view': 'labels.permissions.orders.view',
  'orders.create': 'labels.permissions.orders.create',
  'orders.manage': 'labels.permissions.orders.manage',
  'reports.view': 'labels.permissions.reports.view',
  'roles.view': 'labels.permissions.roles.view',
  'roles.manage': 'labels.permissions.roles.manage',
  'warehouse.view': 'labels.permissions.warehouse.view',
  'warehouse.manage': 'labels.permissions.warehouse.manage',
};
...
const USER_PERMISSION_DESCRIPTION_KEYS: Record<string, string> = {
  ...
  can_view_integrations: 'labels.permissionDescriptions.can_view_integrations',
  can_manage_ai_settings: 'labels.permissionDescriptions.can_manage_ai_settings',
  can_view_ai_settings: 'labels.permissionDescriptions.can_view_ai_settings',
  can_view_logs: 'labels.permissionDescriptions.can_view_logs',
  'dashboard.view': 'labels.permissionDescriptions.dashboard.view',
  'audit_logs.view': 'labels.permissionDescriptions.audit_logs.view',
  ...
  'clients.verify': 'labels.permissionDescriptions.clients.verify',
  ...
  'company.view': 'labels.permissionDescriptions.company.view',
  'company.manage': 'labels.permissionDescriptions.company.manage',
  'members.view': 'labels.permissionDescriptions.members.view',
  'members.manage': 'labels.permissionDescriptions.members.manage',
  'orders.view': 'labels.permissionDescriptions.orders.view',
  'orders.create': 'labels.permissionDescriptions.orders.create',
  'orders.manage': 'labels.permissionDescriptions.orders.manage',
  'reports.view': 'labels.permissionDescriptions.reports.view',
  'roles.view': 'labels.permissionDescriptions.roles.view',
  'roles.manage': 'labels.permissionDescriptions.roles.manage',
  'warehouse.view': 'labels.permissionDescriptions.warehouse.view',
  'warehouse.manage': 'labels.permissionDescriptions.warehouse.manage',
};
