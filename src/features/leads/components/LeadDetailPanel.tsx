...
function LeadDetailPanel({
	...
	const statusOptions = useMemo<SelectOption[]>(
		() => [
			...
			{ value: 'in_progress', label: getLeadStatusLabel(t, 'in_progress' as any) },
			{ value: 'closed', label: getLeadStatusLabel(t, 'closed' as any) },
		],
		[t],
	)
							...
							<PageCard>
								<div className='grid gap-4'>
									...
									<div className='grid gap-2.5 sm:grid-cols-2'>
										...
										<button
											type='button'
											className='rounded-lg bg-surface-subtle/80 p-3 text-left transition duration-fast hover:bg-surface-subtle'
											onClick={() => {
