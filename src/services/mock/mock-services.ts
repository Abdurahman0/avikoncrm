...
let leads = [
	{
		...
		ai_summary: "Savol: 10kW narx va o'rnatish muddati.",
		metadata: {
			region: 'Toshkent',
	...
	},
	{
		...
		manager: 'user-op-1',
		manager_username: 'Operator Avikontex',
		ai_summary: 'Audit va tijorat taklifi bo`yicha dialog davom etmoqda.',
		metadata: {
			region: 'Samarqand',
			last_inbound_at: '2026-05-22T09:05:00.000Z',
			expected_response_at: '2026-05-23T10:00:00.000Z',
			topic: 'To`lov shartlari',
		},
...
let clients = [
	{
		...
		electricity_consumption: '1200 kWh',
		desired_power_kw: 12,
		audit_conclusion_kw: 10,
		eligible_subsidy_kw: 5,
		estimated_subsidy_amount: '15000000',
		monthly_bill: '4800000',
		solution_type: 'on-grid',
		budget_range: '100-150 mln',
		source_platform: 'instagram',
		status: 'proposal_sent',
		manager: 'user-op-1',
		manager_username: 'Operator Avikontex',
		notes: 'Taklif yuborilgan, javob kutilmoqda.',
		ai_summary: 'B2B kelishuv jarayonida.',
		recall_at: null,
		metadata: { preferred_contact: 'telegram' },
	...
	},
	{
		...
		phone: '+998998887766',
		region: 'Farg‘ona',
		address: 'Alisher Navoiy ko‘chasi 8',
		object_type: 'house',
		customer_segment: 'b2c',
		electricity_consumption: '650 kWh',
		desired_power_kw: 8,
		audit_conclusion_kw: 8,
		eligible_subsidy_kw: 4,
		estimated_subsidy_amount: '9600000',
		monthly_bill: '2600000',
		solution_type: 'hybrid',
		budget_range: '60-90 mln',
		source_platform: 'manual',
		status: 'won',
		manager: 'user-admin-1',
		manager_username: 'Admin Avikontex',
		notes: 'Shartnoma imzolangan.',
		ai_summary: 'Muvaffaqiyatli yopilgan mijoz.',
		recall_at: null,
		metadata: { vip: true },
...
let categories = [
	{
		...
		code: 'SOLAR_PANEL',
		sortOrder: 0,
		description: 'Panel mahsulotlari',
		isActive: true,
...
let products = [
	{
		...
		name: 'JA Solar 600W',
		sku: 'JA-600',
		description: 'Yuoqri samarali panel',
		categoryId: 'cat-1',
		category_id: 'cat-1',
	...
	},
	{
		...
		name: 'DEYE 8kW',
		sku: 'DEYE-8',
		description: 'Uy va ofis uchun invertor',
		categoryId: 'cat-2',
		category_id: 'cat-2',
...
let contracts = [
	{
		...
		panel_type: 'jinko_ja',
		inverter_type: 'deye',
		requested_power_kw: 8,
		audit_power_kw: 8,
		audit_conclusion_kw: 8,
		eligible_subsidy_kw: 4,
		estimated_subsidy_amount: '9600000',
		subsidy_percent: '30',
		subsidy_amount: '9600000',
		customer_amount: '22400000',
		total_amount: '32000000',
		customer_phone: '+998998887766',
		installation_address: 'Farg‘ona',
		delivery_status: 'scheduled',
		items: [
			{ id: 'cti-1', product: 'product-1', product_name: 'JA Solar 600W', quantity: 12, unit_price: '1900000' },
			{ id: 'cti-2', product: 'product-2', product_name: 'DEYE 8kW', quantity: 1, unit_price: '9200000' },
		],
		details: { note: 'May 25 installation' },
	...
	},
	{
		...
		customer_amount: '43000000',
		total_amount: '58000000',
		customer_phone: '+998935556677',
		installation_address: 'Samarqand',
		delivery_status: 'in_progress',
		items: [
			{ id: 'cti-3', product: 'product-1', product_name: 'JA Solar 600W', quantity: 18, unit_price: '2000000' },
		],
		details: { note: 'Finance approval pending' },
...
let notifications = [
	...
	{
		id: 'notification-2',
		title: 'Shartnoma to‘lovi kutilmoqda',
		message: '12kW ofis tizimi uchun to‘lov hali tushmadi',
		type: 'warning',
		channel: 'system',
		status: 'read',
		is_read: true,
...
const apiLogs = [
	...
	},
	{
		...
		status_code: 201,
		level: 'info',
		request_data: { title: '8kW uy tizimi' },
...
const aiLogs = [
	{
		...
		response: 'Client is interested in 10kW system.',
		level: 'info',
		tokens_used: 300,
		cost: 0.02,
		error: null,
...
const pricingMatrix = {
	subsidy_percent: '30',
	supported_audit_powers: [4, 6, 8, 10, 12],
	panels: [
		{
			panel_type: 'jinko_ja',
			label: 'Jinko / JA Solar',
			rows: [
				{
					power_kw: 8,
					base_prices: { deye: '32000000', solax: '34000000' },
					default_customer_prices: { deye: '22400000', solax: '23800000' },
					audit_customer_prices: {
						'8': { deye: '21800000', solax: '23200000' },
					},
				},
				{
					power_kw: 12,
					base_prices: { deye: '48000000', solax: '51000000' },
					default_customer_prices: { deye: '33600000', solax: '35700000' },
					audit_customer_prices: {
						'10': { deye: '32900000', solax: '35100000' },
					},
				},
			],
		},
